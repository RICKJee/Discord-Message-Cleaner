...
APP_VERSION = "0.1"
DISCORD_BOT_TOKEN = "[REDACTED]"  # Replace with your bot token
...
# ---------------- Update Check using Discord Bot ----------------
...
def show_about():
    ...
    about.title("About Message Cleaner")
